        ...
        Self {
            ...
            status_patterns: AgentStatusPatterns {
                approval: vec![
                    ...
                    r"\[y\/N\]".into(),
                    r"\(y\/n\)".into(),
                    r"Approve|Reject".into(),
                    r"Do you want to (?:proceed|continue|allow)".into(),
                ],
                thinking: vec![r"thinking".into(), r"Thinking".into(), r"reasoning".into()],
                tool_use: vec![
                    ToolUsePattern {
                        pattern: r"Reading\s+(.+)".into(),
                        tool: "Read".into(),
                ...
                idle: vec![r"^\s*[>❯\$]\s*$".into(), r"packetcode>".into()],
            },
            approval_actions: AgentApprovalActions {
                approve: "y\n".into(),
                deny: "n\n".into(),
