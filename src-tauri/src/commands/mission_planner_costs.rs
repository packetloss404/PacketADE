//! Mission Planner E8 — cost / token accumulation onto the Flight DTO.
//!
//! Extracted from `mission_planner.rs` as a "first cut" of the larger
...
use crate::commands::mission_planner::now_millis;
...
///       commands::mission_planner_costs::e8_accum -- --ignored --test-threads=1`
///
