...
the authority for providers, models, secrets, Workspaces, MCP configuration,
permissions, Memory, and execution. Phone and cloud surfaces supervise that
...
4. Resolve Remote Agents auth and E2EE; execute Sprint 0 against the standalone
...
4. Decide Remote Agents auth and E2EE, then build the PWA/relay alpha.
5. Add hosted CI, signing, notarization, and updater infrastructure.
