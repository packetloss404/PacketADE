...
| --------------------------- | -------: | ---------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| Packaged Windows acceptance |       P1 | 0.13.0 bundles built 2026-08-30 from `49583b5a` and hashed in `CHANGELOG.md`, superseding every earlier pair; sections 0 and 1 of `dev/acceptance-0.13.0.md` have run and found two migration defects. The only packaged install to date was 0.12.1, once, proving just that it registers and launches | Install the 0.13.0 package over a machine carrying pre-rename state; prove the new bundle identifier and the data-dir/keyring migrations end to end; then run sections 2-5 — Terminal panes, Claude statusline, close/lifecycle, dictation on the real headset, analytics, Monitor, accessibility, and denial behavior |
