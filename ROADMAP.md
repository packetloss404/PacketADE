...
Last updated: 2026-08-02 (Workspace/Agents and Settings IA are complete; local
Terminal shell profiles are committed, packaged, and command-probed with Auto
preserving prior launch behavior; Claude's native pane status bar is now
self-bootstrapping; the
...
selected the standalone Rust `packet-relay` service and retains two Sprint-0
decision gates)
...
surface goal. The relay/code-location decision now selects
`D:\projects\packet-relay`; auth provider and E2EE timing remain open.

## Now

| ID  | Track                                     | Priority | Status                                                                                                                                                                  | Canonical Plan                                                                                                                                                                                                                                                                                                                                                                         |
| --- | ----------------------------------------- | -------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| R12 | Local Terminal shell profiles             |       P2 | Shipped in v0.10.3 with Windows detection/command probes and package compile proof; interactive packaged pane/persistence/unavailable-profile matrix remains | [`HANDOFF.md`](./HANDOFF.md), [`backlog.md`](./backlog.md)                                                                                                                                                                                                                                                                                                                             |
...
| R0  | Remote Agents: PWA + Packet Cloud relay   |       P1 | Rust `packet-relay` selected; paused at auth-provider and E2EE launch decisions                                                                                         | [`dev/remoteagents/README.md`](./dev/remoteagents/README.md)                                                                                                                                                                                                                                                                                                                           |
...
| --- | ------------------------- | -------: | ------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D1  | Remote Agents Sprint 0    |       P1 | Relay/code location resolved; two decisions remain                              | Decide auth provider and E2EE timing before product scaffolding; extend the standalone Rust `packet-relay` rather than creating a provider-specific relay.                                                                                                                                                                                                                                                                                                                                    |
...
4. Resolve the two remaining Remote Agents Sprint-0 decisions, then split work against
