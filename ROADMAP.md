...
Terminal shell profiles are source-complete with Auto preserving prior launch
behavior; the
...
| --- | ----------------------------------------- | -------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| R12 | Local Terminal shell profiles             |       P2 | Implemented and source-gated in the current working tree; commit/package and manual shell matrix remain                                                                 | [`HANDOFF.md`](./HANDOFF.md), [`backlog.md`](./backlog.md)                                                                                                                                                                                                                                                                                                                             |
