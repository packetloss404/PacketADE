...
4. **DEFERRED ON COST 2026-08-27 - Code-signing identity.** Not neglect and
   ...
   **What stays blocked meanwhile:** distribution trust and hosted gates
   ...
   2026-08-16; PacketBench continues the 0.x cadence (now 0.12.1) with no 1.0
   milestone. See
...
- **P2 - Packaged acceptance sections 2-5 at 0.12.1.** Section 0 (build) and
  section 1 (migration) of
  [`dev/acceptance-0.12.1.md`](./dev/acceptance-0.12.1.md) have run; section 1
...
- **P1 - Packaged application acceptance.** Run the launch, lifecycle,
  ...
  [`dev/acceptance-0.12.1.md`](./dev/acceptance-0.12.1.md), which supersedes the
