  ...
  return (
    <div className="rounded-lg border border-bg-border bg-bg-secondary p-4">
      ...
      <p className="mt-3 border-t border-bg-border pt-2 text-[10px] leading-snug text-text-muted">
        ...
        this setting. Away from UTC they can disagree with the dictation History list, which does
        follow it, for entries near midnight. The Analytics tab says so inline rather than leaving
        it to this card.
      </p>

      <p className="mt-2 text-[10px] leading-snug text-text-muted">
        Still on the host zone: the Issue detail pane, Code Quality run stamps, and the Memory
        project-notes list. They format dates without going through{" "}
