...
// Local copy: shared `timeAgo` / `StateFilterChip` helpers remain in
// GitHubView.tsx (used by IssueList + ActivityFeed). Duplicated here so
// extraction does not require touching unrelated inline blocks.
