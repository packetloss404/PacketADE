...
| Implemented-feature proof audit      | [`proof-audit-2026-08-01.md`](./proof-audit-2026-08-01.md)                                                                                                                                                                           | **CURRENT** — final integrated source-level counts plus an honest matrix of the commit-bound, real-runtime, packaged, credential, hardware, and cross-platform gates that remain.                                                                                                                                                                                                                                                                                                                   |
