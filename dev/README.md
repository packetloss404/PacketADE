...
| Gitea/Forgejo support loop  | [`gitea-support-loop.md`](./gitea-support-loop.md)                                                                                                                                                                                    | Scoped loop (G1–G14) — self-hosted Gitea/Forgejo alongside GitHub, both configurable at once, resolved per-workspace from the origin remote. Peer-reviewed on `feat/gitea-support` (pending merge). |
