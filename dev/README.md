...
| [`acceptance-0.11.0.md`](./acceptance-0.11.0.md)                             | **ACTIVE CHECKLIST** - the packaged 0.11.0 acceptance matrix. Ordered and runnable; starts with a rebuild, because the installers on disk predate the dictation work |
