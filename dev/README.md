...
| [`acceptance-0.12.1.md`](./acceptance-0.12.1.md)                             | **ACTIVE CHECKLIST** - the packaged acceptance matrix, retargeted 0.11.0 -> 0.12.0 -> 0.12.1 on 2026-08-28 as each build was superseded. Sections 0 (build) and 1 (migration) have run and found two defects; sections 2-5 need a person at the keyboard with the headset attached |
