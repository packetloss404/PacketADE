...
| Pre-Remote-Agents loop queue | [`bridgemind/pre-remote-agents-loop-queue.md`](./bridgemind/pre-remote-agents-loop-queue.md)                                                                                                                                          | PREPARED, PAUSED — one ordered run from implemented Flight proof through Dictation, Trust/Provenance, Memory Hub, MCP Hub, and convergence; requires one user confirmation before execution. |
...
| Project-local Memory Hub     | [`bridgemind/project-local-memory-hub-loop.md`](./bridgemind/project-local-memory-hub-loop.md)                                                                                                                                        | APPROVED, QUEUED — Option B adds Markdown-backed project memory, links/backlinks, graph/orphans, provenance, retrieval, and scoped MCP access inside PacketADE. |
| Local-first MCP Hub          | [`bridgemind/local-first-mcp-hub-loop.md`](./bridgemind/local-first-mcp-hub-loop.md)                                                                                                                                                  | APPROVED, LATER — Option B consolidates the shipped client/provider substrate with catalog, health, trust profiles, provenance, and suite resources; not the first PacketADE focus. |
| Dictation repair loop        | [`bridgemind/dictation-repair-hardening-loop.md`](./bridgemind/dictation-repair-hardening-loop.md)                                                                                                                                    | OPTION B IMPLEMENTED — native format conversion/resampling, model/device readiness, lifecycle/cancel, dictionary/language, delivery, and history repaired; physical mic smoke is environment-gated. |
| Trust and provenance loop    | [`bridgemind/trust-provenance-loop.md`](./bridgemind/trust-provenance-loop.md)                                                                                                                                                        | APPROVED, QUEUED — one source/authority/integrity/lineage contract across agent, MCP, web, review, Flight, and Memory surfaces with existing permission/autonomy enforcement. |
...
The current combined loop source passes `pnpm lint` (zero errors), all 1,174
