...
| Workspace/Agents + Settings decision | [`workspace-agent-settings-decision-2026-07-29.md`](./workspace-agent-settings-decision-2026-07-29.md)                                                                                                                       | DECISION PENDING — current code audit plus refreshed Cursor/VS Code/Codex/Claude/BridgeSpace evidence recommends CLI-first Workspaces, a same-window Agents surface first, a later single-writer detachable window, and a six-group Settings cleanup.                                                    |
...
| Multi-monitor operations     | [`send-to-monitor-plan.md`](./send-to-monitor-plan.md)                                                                                                                                                                               | V1 SOURCE COMPLETE — one reusable read-only Agent/Flight Monitor with backend lease, separate shell, and narrow capability; packaged multi-display proof and later surfaces remain.                                                                                                                     |
...
- Workspace/Agents placement and the Settings reorganization are documented
  in
  [`workspace-agent-settings-decision-2026-07-29.md`](./workspace-agent-settings-decision-2026-07-29.md).
  No surface migration is approved yet. The report recommends CLI-first
  Workspaces, a same-main-window Agents surface before interactive popouts,
  and removal or enforcement of placebo Settings controls.
