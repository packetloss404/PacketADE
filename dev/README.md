...
| [`acceptance-0.12.0.md`](./acceptance-0.12.0.md)                             | **ACTIVE CHECKLIST** - the packaged acceptance matrix, retargeted from 0.11.0 to 0.12.0 on 2026-08-28. Sections 0 (build) and 1 (migration) have run and found two defects; sections 2-5 need a person at the keyboard with the headset attached |
