...
| Workspace/Agents + Settings evidence | [`workspace-agent-settings-decision-2026-07-29.md`](./workspace-agent-settings-decision-2026-07-29.md)                                                                                                                               | Completed code/landscape/Settings audit supporting the active Workspace/Agents goal; the six-group Settings reorganization remains a separate owner decision.                                                                                                                        |
...
- The six-group Settings reorganization and specific control corrections remain
