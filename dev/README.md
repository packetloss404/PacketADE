...
| Memory v0.9+ loop           | [`memory-v9-loop.md`](./memory-v9-loop.md)                                                                                                                                                                                            | Scoped loop (M1–M10) fleshing out the Memory pane: fixes half-wired gaps (search/task_completed/confidence/retrospective) + ships the deferred enhancements. Embeddings deferred. |
