...
| Syndicate target         | [`syndicate-execution-target.md`](./syndicate-execution-target.md)                                 | **SOURCE COMPLETE** - PacketADE flagship target, pairing/scopes/revoke, Host Workspaces, durable panes/replay, pinned-SSH bootstrap, encrypted PacketRelay, and isolation pass; public relay + live installer deployment and packaged matrix remain |
